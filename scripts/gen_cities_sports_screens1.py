...
# 1. City Directory (/cities)
write_file('src/app/cities/page.tsx', """'use client';
...
# 2. Dynamic City Page (/cities/[citySlug])
write_file('src/app/cities/[citySlug]/page.tsx', """'use client';
...
print('[DONE] Part 1 Screens generated.')
