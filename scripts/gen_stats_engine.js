...
const statsEngineCode = `import { prisma } from '../lib/prisma';
...
fs.writeFileSync('src/services/stats-engine.ts', statsEngineCode.trim() + '\n', 'utf8');
console.log('[OK] Updated src/services/stats-engine.ts');
