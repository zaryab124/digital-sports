const fs = require('fs');
fs.mkdirSync('src/components/notifications', { recursive: true });

const bellCode = `'use client';
...
fs.writeFileSync('src/components/notifications/NotificationBell.tsx', bellCode.trim() + '\n', 'utf8');
console.log('[OK] Created src/components/notifications/NotificationBell.tsx');
