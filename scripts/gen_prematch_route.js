const fs = require('fs');
fs.mkdirSync('src/app/api/scorebook/[matchId]/prematch', { recursive: true });

const prematchRoute = `import { NextRequest, NextResponse } from 'next/server';
...
fs.writeFileSync('src/app/api/scorebook/[matchId]/prematch/route.ts', prematchRoute.trim() + '\n', 'utf8');
console.log('[OK] Created src/app/api/scorebook/[matchId]/prematch/route.ts');
