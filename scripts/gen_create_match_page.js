...
const createMatchPage = `'use client';
...
fs.writeFileSync('src/app/matches/create/page.tsx', createMatchPage.trim() + '\n', 'utf8');
console.log('[OK] Created enhanced src/app/matches/create/page.tsx');
