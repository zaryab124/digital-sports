...
const rankingsRoute = `import { NextRequest, NextResponse } from 'next/server';
...
fs.writeFileSync('src/app/api/rankings/route.ts', rankingsRoute.trim() + '\n', 'utf8');
console.log('[OK] Created src/app/api/rankings/route.ts');
