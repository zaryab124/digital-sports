...
const actionRoute = `import { NextRequest, NextResponse } from 'next/server';
      ...
      if (match.homeTeam.captainId) {
        await prisma.notification.create({
          data: {
            ...
            title: 'Opponent Captain Accepted Match Proposal',
...
fs.writeFileSync('src/app/api/matches/[id]/action/route.ts', actionRoute.trim() + '\n', 'utf8');
console.log('[OK] Created src/app/api/matches/[id]/action/route.ts');
