...
const approveRoute = `import { NextRequest, NextResponse } from 'next/server';
...
fs.writeFileSync('src/app/api/transfers/[id]/approve/route.ts', approveRoute.trim() + '\n', 'utf8');
console.log('[OK] Created src/app/api/transfers/[id]/approve/route.ts');
