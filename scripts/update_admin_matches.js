...
const updatedMatchesRoute = `import { NextRequest, NextResponse } from 'next/server';
...
fs.writeFileSync('src/app/api/admin/matches/route.ts', updatedMatchesRoute.trim() + '\n', 'utf8');
console.log('[OK] Updated src/app/api/admin/matches/route.ts with notifications and realtime events');
